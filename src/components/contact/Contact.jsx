    ...
    <motion.div className="contact" variants={variants} initial="initial" whileInView="animate">
        ...
        <div className="formContainer">
            <motion.div className="mailSvg"  initial={{opacity:1}} whileInView={{opacity:0}} transition={{delay:2, duration:1}}>
                <svg width="482px" height="482px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <motion.form action=""  initial={{opacity:0}} whileInView={{opacity:1}} transition={{delay:3, duration:1}}>
